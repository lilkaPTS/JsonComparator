...
public class Hashes__4 {
    ...
    public Hashes__4 withSha1(String sha1) {
        this.sha1 = sha1;
        return this;
    }
    ...
    public Hashes__4 withSha256(String sha256) {
        this.sha256 = sha256;
        return this;
    }
    ...
    public Hashes__4 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hashes__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sha1");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hashes__4) == false) {
            return false;
        }
        Hashes__4 rhs = ((Hashes__4) other);
