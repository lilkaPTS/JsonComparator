...
public class Hashes__2 {
    ...
    public Hashes__2 withSha1(String sha1) {
        this.sha1 = sha1;
        return this;
    }
    ...
    public Hashes__2 withSha256(String sha256) {
        this.sha256 = sha256;
        return this;
    }
    ...
    public Hashes__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hashes__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sha1");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hashes__2) == false) {
            return false;
        }
        Hashes__2 rhs = ((Hashes__2) other);
