...
public class Hashes__1 {
    ...
    public Hashes__1 withSha1(String sha1) {
        this.sha1 = sha1;
        return this;
    }
    ...
    public Hashes__1 withSha256(String sha256) {
        this.sha256 = sha256;
        return this;
    }
    ...
    public Hashes__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hashes__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sha1");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hashes__1) == false) {
            return false;
        }
        Hashes__1 rhs = ((Hashes__1) other);
